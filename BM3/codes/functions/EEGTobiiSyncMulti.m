% FUNCTION TO SYNCHRONIZE MULTIPLE TRIALS OF EEG AND TOBII TIMETABLES. 
% FUNCTION CREATES AND SAVES SYNCHRONIZED TIMETABLE TO APPROPRIATE 
% DIRECTORY FOR A PARTICULAR TRIAL
...
function [] = EEGTobiiSyncMulti(YEAR, MONTH, DAY, USER, EEG, Tobii,...
