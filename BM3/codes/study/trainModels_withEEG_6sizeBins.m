...
% choose predictors
varnames = ["Temp" "GSR_uS" "PupilCenter_Distance" "HRV_rMSSD" ...
    "Oz_delta" "FC6_delta" "FC6_alpha" "T8_delta" "PO7_delta"];
[~,i,~] = intersect(Predictors.Properties.VariableNames, varnames);
Predictors = Predictors(:, sort(i));
...
dataDirectory = strcat(curDir,"/Models/BM-", string(numVars), ...
        "_PM-",string(numModels), ...
        "_Trials-", numTrialsString, ...
        '_TP-',string(100*trainPercent), "_withEEG/_data");
